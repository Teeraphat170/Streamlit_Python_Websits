    ...
    with placeholder.container():
        ...
        with col2:
            ...
            Text = """สำหรับหน้าเว็บนี้จะเป็น  Dashboard ไว้ใช้สำหรับดูและตรวจสอบผลการทำงานของ PLC  
                ...
                ในขณะที่เครื่องทำงานอยู่ โดยวิธีใช้คือ ในส่วนของ Change Dataset นั้นเอาไว้เลือก Data ที่จะเอามาใช้ Setting 
                คือตั้งค่าต่างๆก่อนที่จะเริ่มการแสดง Dashboard โดยมีรายละเอียดดังนี้ 
                \n1.Change Row After Sliding Windows เอาไว้ทำการสไลด์ Row
                ตามที่กำหนดไว้ เช่น ถ้าเลือกไว้ 5 จาก Row ที่ 1-400 สไลด์ต่อไปก็จะเป็น Row ที่ 6-405 
